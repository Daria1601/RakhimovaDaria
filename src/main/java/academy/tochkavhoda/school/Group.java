...
public class Group {
    ...
    public Trainee getTraineeByFirstName(String firstName) throws TrainingException {
        return trainees.stream()
                .filter(t -> Objects.equals(t.getFirstName(), firstName))
                .findFirst()
    ...
    public Trainee getTraineeByFullName(String fullName) throws TrainingException {
        return trainees.stream()
                .filter(t -> Objects.equals(t.getFullName(), fullName))
                .findFirst()
                .orElseThrow(() -> new TrainingException(TrainingErrorCode.TRAINEE_NOT_FOUND));
    }
    ...
    public List<Trainee> getTraineesWithMaxRating() throws TrainingException {
        ...
        int max = trainees.stream().mapToInt(Trainee::getRating).max().orElseThrow();
        return trainees.stream().filter(t -> t.getRating() == max).toList();
    }
